...
TerrainFilteringNode::TerrainFilteringNode() : Node("terrain_filtering_node") {
  ...
  raw_points_sub_ = this->create_subscription<sensor_msgs::msg::PointCloud2>(
      ...
      std::bind(&TerrainFilteringNode::rawPointsCallback, this,
                std::placeholders::_1));
}

void TerrainFilteringNode::rawPointsCallback(
    const sensor_msgs::msg::PointCloud2::SharedPtr msg) {
  try {
    geometry_msgs::msg::TransformStamped transformStamped;

    if (tfBuffer_->canTransform(target_frame_, source_frame_,
                                tf2::TimePointZero)) {
      ...
      // convert sensor_msgs::msg::PointCloud2::SharedPtr to
      ...
      // setup output cloud
      pcl::PointCloud<pcl::PointXYZ>::Ptr xyz_filtered_cloud(
          new pcl::PointCloud<pcl::PointXYZ>);

...
public:
  ToolPlanner(double design_blade_height, double raised_blade_height)
      : design_blade_height_(design_blade_height),
        raised_blade_height_(raised_blade_height), autograder_enabled_(false) {}

  // Updates the trajectory.tool_positions field in-place
  void generateToolTargets(cg_msgs::msg::Trajectory &trajectory,

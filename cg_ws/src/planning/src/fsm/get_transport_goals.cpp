...
void GetTransportGoals::runState(
  ...
  // transport_planner.getGoalPose(agent_pose, map); while (goalPoses.size() >
  // 0) {
  //   viz_state_l1_goal_poses.insert(viz_state_l1_goal_poses.end(),
  //   goalPoses.begin(), goalPoses.end()); goalPoses =
  //   transport_planner.getGoalPose(agent_pose, map);
  // }

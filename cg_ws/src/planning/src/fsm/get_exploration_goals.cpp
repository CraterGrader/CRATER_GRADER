...
void GetExplorationGoals::runState(std::vector<cg_msgs::msg::Pose2D> &current_goal_poses, cg::planning::ExplorationPlanner &exploration_planner, const cg_msgs::msg::Pose2D &agent_pose, const cg::mapping::Map<float> &map){

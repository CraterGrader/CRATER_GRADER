...
#define ROBOCLAW_READ_TIMEOUT_USEC 8000 // 8k --> ~5.5hz, lower = faster loop but below 8k observed to not successfully read from the RoboClaws (tested 7k, 6k, 5k, 100)

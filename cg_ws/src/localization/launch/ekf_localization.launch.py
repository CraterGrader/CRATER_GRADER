    ...
    return LaunchDescription(
        [
            Node(
                ...
                remappings=[("odometry/filtered", "odometry/filtered/ekf_odom_node")],
            ),
            Node(
                package="robot_localization",
                executable="ekf_node",
                ...
                remappings=[("odometry/filtered", "odometry/filtered/ekf_global_node")],
            ),
            Node(
            ...
            Node(
                ...
                remappings=[("odometry/filtered", "odometry/filtered/ekf_slip_node")],
            ),
        ]
    )
